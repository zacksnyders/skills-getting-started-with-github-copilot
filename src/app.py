...
activities = {
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["luna@mergington.edu", "grace@mergington.edu"]
    },
    "Music Band": {
...
if __name__ == "__main__":
    # Allow running with `python src/app.py` for convenience.
    # For development with auto-reload, prefer: `uvicorn src.app:app --reload`
    import uvicorn
